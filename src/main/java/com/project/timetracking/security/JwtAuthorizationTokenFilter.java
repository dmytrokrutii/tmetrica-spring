 ...
 * Is added to filter chain in {@link com.project.timetracking.config.WebSecurityConfig}
 */
@Component
public class JwtAuthorizationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            logger.trace("security context was null, so authorization user");
            ...
            if (jwtTokenUtil.validateToken(authToken, userDetails)) {
                ...
                logger.trace("authorized user '{}', setting security context", username);
